...
@Composable
fun VaccineAwaitingSignatureCard(
    ...
    if (showBottomSheet) {
        VaccineAwaitingSignatureCardModalBottomSheet(
...
@Composable
fun VaccineAwaitingSignatureCardModalBottomSheet(
    vaccineRequest: VaccineRequestResponse,
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = "Esta solicitação de vacina foi preenchida com os dados da aplicação, mas ainda não foi assinada digitalmente pelo médico veterinário.",
                style = MaterialTheme.typography.bodyMedium,
